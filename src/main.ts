...
const viewerContainer = document.getElementById("sp-ifc-app-viewer") as HTMLDivElement
...
//ADD EVENT TO LOAD THE FILE FROM SHAREPOINT
window.addEventListener("openifc",async (event:any) => {
